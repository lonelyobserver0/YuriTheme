...
#                            os.path.expanduser("~/.config/waybar/colors-waybar.css")], check=True)
            subprocess.run([os.path.expanduser("~/PycharmProjects/YuriTheme/css-to-scss-waybar.sh")], check=True)
        except subprocess.CalledProcessError as e:
    ...
    if file_exists("~/.cache/wal/colors-waybar.css"):
        try:
            subprocess.run([os.path.expanduser("~/PycharmProjects/YuriTheme/css-to-scss-swaync.sh")], check=True)
        except subprocess.CalledProcessError as e:
